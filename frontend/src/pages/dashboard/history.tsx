...
// import { logAPI } from "../../axios/log.api"; // added import
...
//   // Khởi tạo state historyData ban đầu là rỗng
//   const [historyData, setHistoryData] = useState([]);
  
//   // Call API lấy warning và error logs
//   useEffect(() => {
//     const fetchLogs = async () => {
//       try {
//         // Giả sử API nhận filter qua params 
//         const params = { level: "warning,error" };
//         const data = await logAPI.getAllLogs(params);
//         // Nếu data chứa property 'logs' thì dùng data.logs, ngược lại dùng data trực tiếp
//         setHistoryData(data.logs || data);
//       } catch (error) {
